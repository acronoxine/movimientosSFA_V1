...
<div id="todo">
    ...
    <div id="cuerpo">
    <div id="tituloarriba">
   		<div id="titulosup">Pren�mina</div>    
    </div>
    	<div id="panelizq">
			<? include("menu.php"); ?>
        </div>
            ...
            <table width="700" border="0" align="center" cellpadding="1" cellspacing="5" style="border:1px solid #E6E4E4;">
              <tr>
                <td align="center" colspan="2" bgcolor="#CCCCCC">
                	<label class="label">Pren�mina</label>
                </td>
              </tr>
              <tr>
                <td colspan="2">
              ...
              <tr>
                  ...
                  <tr>
                    <td>
                        <input class="boton2" type="button" name="limpiar" id="limpiar" value="LIMPIAR" onClick="location.replace('prenomina.php');">
                    </td>
                    <td align="right">
    ...
    <div id="tituloabajo">
   		<div id="tituloinf">Pren�mina</div>    
    </div>
</div>
</body>
</html>