...
<body topmargin="0" leftmargin="0">
  ...
  <?php do { ?>
    	<!-- <tr id="<? //echo $row_plazas["idnominaemp"]; ?>" class="message_box tablaregistros" onClick="miseleccion('<?php //echo $row_plazas['idnominaemp']; ?>', 'id_<?php //echo $row_plazas['idnominaemp']; ?>')">-->
			<tr id="<? echo $row_plazas["idnominaemp"]; ?>"
				class="message_box tablaregistros">

				<td width="50" height="60" align="center"><a
					onClick="ver(<?php echo $row_plazas['idmh']; ?>)" href="#"><img
						src="imagenes/pdf-h.png" width="34" height="34"></a></td>
				<td width="120" align="center">
			 <?php
			$fecha_formato = explode ( ' ', $row_plazas ['fecha_movimiento'] );
			echo $fecha_formato [0]?><span style="vertical-align: bottom"> <img
						src="imagenes/reloj.png" width="12" height="12"></span>
