    ...
    <div id="cuerpo">
        ...
        <div id="centro_prin">
                <div id="cfdi" style="margin: 10px auto; width: 350px; padding-top: 50px;">
                	<iframe name="factura" id="factura" src="http://nominaejemplo.michoacan.gob.mx/xml_nominacetic/nomina.cfm" style="width: 400px; height: 200px; border: 0px;"></iframe>
                </div>
        </div>
    </div>
    <div id="tituloabajo">
   		<div id="tituloinf">CFDI</div>    
    </div>
</div>
</body>
</html>