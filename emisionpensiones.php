...
if(isset($_POST["boton"]) && $_POST["boton"] == "cierre")
{
	...
	echo "<script>";
	echo "location.replace('emisionpensiones.php');";
	echo "</script>";
	exit();
}
...
function cierre(form)
{
	if(form.quincena.value == '') 
	{
		...
		{
			form.action = "emisionpensiones.php";
			form.target = "_top";
			form.submit();
		}
	}
...
<div id="todo">
    ...
    <div id="cuerpo">
    <div id="tituloarriba">
   		<div id="titulosup">Emisi&oacute;n de pensiones</div>    
    </div>
    	<div id="panelizq">
			<? include("menu.php"); ?>
        </div>
            ...
            <table width="700" border="0" align="center" cellpadding="1" cellspacing="5" style="border:1px solid #E6E4E4;">
              <tr>
                <td align="center" colspan="2" bgcolor="#CCCCCC">
                	<label class="label">Emisión de pensiones</label>
                </td>
              </tr>
              <tr>
                <td colspan="2">
    ...
    <div id="tituloabajo">
   		<div id="tituloinf">Emisi&oacute;n de pensiones</div>    
    </div>
</div>
</body>
</html>