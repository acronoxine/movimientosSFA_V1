	...
	*/
	...
	function set_upp(){
		...
		jQuery.ajax({
			      type		: "POST",
			      dataType	: "json",
			      url		: "jQuery_save_titulares.php", //Relative or absolute path to response.php file
			      data		: {
				      			upp 		: 	upp,
				...
				<fieldset>
					<table style="text-align: center; position:relative; left:250px;">
						<form name="form_upp" action="">
							...
							<tr><input type="hidden" name="upp" id="upp_titular" value="1"></tr>
							<tr>
								<td><label>NOMBRE</label></td>
						    	<td><input name="upp_nombre" id="upp_nombre" size="35"></td>
						    </tr>
						    <tr> 
						    	<td><label>PUESTO</label></td>
						    	<td><input name="upp_puesto" id="upp_puesto" size="35"></td>
						    </tr>
						    <tr>
						    	<td><input class="btn-form" type="button" name="submit_upp" value="Guardar" onclick="set_upp()"></td>
						    </tr>
				...
				<fieldset style="float: left; width: 95%; heigth: 50%;">
					<table style="text-align: center; position:relative; left:250px;">
						<form name="form_ur" action="">
							...
							<tr><input type="hidden" name="ur" id="ur_titular" value="2"></tr>
							<tr>
								<td><label>NOMBRE</label></td>
						    	<td><input name="ur_nombre" id="ur_nombre" size="35"></td>
						    </tr>
						    <tr> 
						    	<td><label>PUESTO</label></td>
						    	<td><input name="ur_puesto" id="ur_puesto" size="35"></td>
						    </tr>
						    <tr>
						    	<td><input class="btn-form" type="button" name="submit_ur" value="Guardar" onclick="set_ur()"></td>
						    </tr>
						</form>
					</table>
				</fieldset>
				<fieldset style="float: left; width: 95%; heigth: 50%;">
					<table style="text-align: center; position:relative; left:250px;">
						<form name="form_rh" action="">
							...
							<tr><input type="hidden" name="rh" id="rh_titular" value="3"></tr>
							<tr>
								<td><label>NOMBRE</label></td>
						    	<td><input name="rh_nombre" id="rh_nombre" size="35"></td>
						    </tr>
						    <tr> 
						    	<td><label>PUESTO</label></td>
						    	<td><input name="rh_puesto" id="rh_puesto" size="35"></td>
						    </tr>
						    <tr>
						    	<td><input class="btn-form" type="button" name="submit_rh" value="Guardar" onclick="set_rh()"></td>
						    </tr>
						</form>
					</table>
				</fieldset>
