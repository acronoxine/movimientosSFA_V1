...
$query_programa = "SELECT * FROM cat_programa group by clave";
...
<body topmargin="0" leftmargin="0">
	<div id="todo">
		...
		<div id="cuerpo">
			...
			<div id="centro_prin">
				<form method="post" name="form1" action="cat_subprogramas_lista.php"
					target="lista">
					<table align="center">
						<tr valign="baseline">
							<td nowrap align="right"><label class="label">Clave:</label></td>
							<td><input class="campo" type="text" name="clave" value=""
								size="32" maxlength="4"
								onKeyPress="return solonumeros(this.form, event)"></td>
						</tr>
						<tr valign="baseline">
							<td nowrap align="right"><label class="label">Descripci&oacute;n:</label></td>
							<td><input class="campo" type="text" name="descripcion" value=""
								size="32" maxlength="150"></td>
						</tr>
						<tr valign="baseline">
							<td nowrap align="right"><label class="label">Programa:</label></td>
							<td><select name="programa" class="lista" style="width: 20.7em;">
									<option value="">Seleccione</option>
                  <?php
																		do {
																			?>
                  <option
										value="<?php echo $row_programa['idprograma']?>"><?php echo $row_programa['descripcion']?></option>
                  <?php
						...
						<tr valign="baseline">
							...
							<td><input class="boton" type="button" name="guardar"
								id="guardar" value="GUARDAR"
								onClick="if(valida(this.form)) submit();"> <label class="label">Consulta
									por Subprograma:</label> <input class="campo" type="text"
								name="consulta" id="consulta" value=""
								onKeyup="busca(this.value);"></td>
						</tr>
						<tr>
							<td colspan="2"><iframe name="lista" id="lista"
									src="cat_subprogramas_lista.php"
									style="width: 800px; height: 400px;"></iframe></td>
						</tr>
					</table>
