	...
	$("#excel").click(function() {
		...
		if(form1.quincena.value != "" && form1.quincena.value != "")
		{
			if(form1.boton.value == "N" || form1.boton.value == "R")
			{
				...
				alert("Genere la quincena antes de generar el archivo de dispersión, de click en TABULADOR ó RECIBOS.");
			}
		}else{
...
<div id="todo">
    ...
    <div id="cuerpo">
    <div id="tituloarriba">
   		<div id="titulosup">Emisión de la nomina</div>    
    </div>
    	<div id="panelizq">
			<? include("menu.php"); ?>
        </div>
            ...
            <table width="700" border="0" align="center" cellpadding="1" cellspacing="5" style="border:1px solid #E6E4E4;">
              <tr>
                <td align="center" colspan="2" bgcolor="#CCCCCC">
                	<label class="label">Emisión de Nómina de Empleados</label>
                </td>
              </tr>
              <tr>
                <td colspan="2">
    ...
    <div id="tituloabajo">
   		<div id="tituloinf">Emisión de la nómina</div>    
    </div>
</div>
</body>
</html>