<?
	...
	$pdf->cell(57,7,"", 1, 0, 'C');	
	$pdf->cell(66,7,"QUINCENA ACTUAL", 1, 0, 'C');
	$pdf->cell(66,7,"QUINCENA DE COMPARACIÓN", 1, 0, 'C');

	$pdf->Ln(7);
	
	$pdf->cell(57,7,"TRABAJADOR", 1, 0, 'C');
	$pdf->cell(22,7,"PERCEPCIONES", 1, 0, 'C');
	$pdf->cell(22,7,"DEDUCCIONES", 1, 0, 'C');
	$pdf->cell(22,7,"NETO A PAGAR", 1, 0, 'C');
	$pdf->cell(22,7,"PERCEPCIONES", 1, 0, 'C');
	$pdf->cell(22,7,"DEDUCCIONES", 1, 0, 'C');
	$pdf->cell(22,7,"NETO A PAGAR", 1, 0, 'C');
