...
<body>
	<iframe name="formato" id="formato"
		src="pdfmovimiento.php?qvacante=<? echo $queryVacante?>&idnominaemp=<? echo $_GET["idnominaemp"]; ?> &ver=<? echo $_GET[ver]?>"
		style="width: 950px; height: 600px;"></iframe>
	<form name="afectacion" method="post" action="imovimientoper.php">
		<table width="100%" border="0">
			<tr>
				<td><label class="label">Movimiento:</label><br> <select
					name="movimiento" id="movimiento" class="lista">
        ...
        <?
								...
								?>
        </select> <input class="boton2" type="button" name="afectar"
					id="afectar" value="Recargar PDF" onClick="(submit())"></td>
				<td>&nbsp;</td>
				<td align="right"><input class="boton" type="button" name="cerrar"
					id="cerrar" value="CERRAR" onClick="cierre()"></td>
			</tr>
		</table>
		<input type="hidden" name="idnominaemp" id="idnominaemp"
			value="<? echo $_GET["idnominaemp"]; ?>">
	</form>
</body>
</html>
